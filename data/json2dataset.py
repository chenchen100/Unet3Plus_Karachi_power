...
if __name__ == '__main__':
    jpgs_path = "origin_img"  # 勾画出样本的原始影像块
    pngs_path = "segment_img"  # 影像块所对应的标签图像

    # classes = ["_background_", "power_plant", "nuclear_power_plants", "oil_and_LNG_terminal",
    #            "oil_and_LNG_storage_facilities", "offshore_photovoltaics", "offshore_wind_power",
    #            "land_photovoltaics"]
    classes = ["_background_", "power_plant", "nuclear_power_plants", "oil_and_LNG_terminal",
